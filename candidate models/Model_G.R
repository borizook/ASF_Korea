...
setwd("/Results/")
folder_scen = paste0("Model_G",scen_num)
...
pars_estimate = c("amplitutde of beta", 
                  "minimum of beta",
                  "detectibility")
pars = c(0.07, 5/2, 0.37, 2 ,1/4.66, 1/5.88, 0.073, 0.2, 1)
